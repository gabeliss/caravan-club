...
def scrape_munisingKoa_api(num_travelers, start_date, end_date, retry_count=0, max_retries=3):
        ...
        if post_response.status_code == 200 and post_response.text:
            ...
            if error_msg and "rate limit" in error_msg.text.lower():
                ...
                if retry_count < max_retries:
                    ...
                    return scrape_munisingKoa_api(num_travelers, start_date, end_date, 
...
def main():
    # Single request
    munisingKoaData = scrape_munisingKoa_api(2, '06/08/25', '06/10/25')
